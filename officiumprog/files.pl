...
$savesetup='0';; #0=don't use edit for show files, 1-use edit (localhost only)
...
C9,Officium defunctorum,
C10,Beata Maria Virginis in Sabbato
C11,Commune Beatae Mariae Virginis,
C12,Officium Parvum Ceatae Mariae Virginis
